...
tic;
[ drought droughtclasses droughtA droughtMA droughtMAM droughtMAS droughtMAE droughtADD droughtADS droughtADI] = STAND_LS_NCDA( spei,mask );
toc;
...
for tt=1083%:1116%length(droughtclasses)
    ...
    title(['Drought classes, ',num2str(date(tt,1)),'/',num2str(date(tt,2))]);
    pause(0.2)
end
